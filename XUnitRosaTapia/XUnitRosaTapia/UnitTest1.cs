...
namespace XUnitRosaTapia
{
    public class UnitTest1 : IDisposable
    {
        public IWebDriver _driver = new ChromeDriver(@"C:\Users\rtapia\source\repos\XUnitRosaTapia\XUnitRosaTapia\bin\Debug\netcoreapp3.1\");
        ...
        public void Login(string a, string b)
        {
            ...
            txtCorreodef.Click();
            txtCorreodef.SendKeys("rtapia@sipecom.com");
            Thread.Sleep(2000);
            var txtCorreocOP = _driver.FindElement(By.Id(txtCC));
            txtCorreocOP.Click();
            txtCorreocOP.SendKeys("rtapia@sipecom.com");
            Thread.Sleep(2000);
